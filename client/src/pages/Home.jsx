        ...
        <div className="min-h-screen bg-gray-50 font-sans">
            ...
            <section className="py-20 px-6 max-w-6xl mx-auto" id="features">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    <Feature icon={Lock} title="Privacy Guaranteed" desc="Your photos never leave your device. All processing happens locally in your browser using WebAssembly." />
                    <Feature icon={Zap} title="Lightning Fast" desc="No server uploads means zero latency. Edit heavy files instantly without waiting for transfer speeds." />
                    <Feature icon={Globe} title="Universal Compatibility" desc="Works on any device—desktop, tablet, or mobile. Consistent experience across all modern browsers." />
                </div>
            </section>
            ...
            <section className="bg-gray-100 py-20 px-6" id="faq">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid gap-6">
                        <FAQ question="Is this tool really free?" answer="Yes! PixEdit is completely free and open source. There are no hidden fees, premium tiers, or watermarks." />
                        <FAQ question="Are my photos uploaded to a server?" answer="No. We use client-side technology (Canvas & WebAssembly) to process images directly on your device. Your data stays with you." />
                        <FAQ question="What formats do you support?" answer="We currently support JPEG, PNG, WEBP, and GIF for input. You can convert between these formats easily." />
                        <FAQ question="Can I use this on my phone?" answer="Absolutely. The interface is fully responsive and touch-friendly for iOS and Android devices." />
                    </div>
                </div>
            </section>
            ...
            <footer className="bg-gray-900 text-gray-400 py-12 px-6 border-t border-gray-800">
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex gap-8 text-sm font-medium">
                        ...
                        <Link to="/crop" className="hover:text-white transition-colors">
                            Crop
                        </Link>
                ...
                <div className="border-t border-gray-800 mt-10 pt-6 text-center text-xs text-gray-600">&copy; {new Date().getFullYear()} PixEdit. Released under MIT License.</div>
            </footer>
        </div>
    );
};
